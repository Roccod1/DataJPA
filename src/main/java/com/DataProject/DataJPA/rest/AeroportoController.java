...
@Api(tags = {"Aeroporto"}, description = "Operazioni relative agli Aeroporti")
@RestController
@CrossOrigin
...
public class AeroportoController {
	...
	public ResponseEntity<Aeroporto> getAeroportoIcao(@ApiParam(value = "Codice Aviazione Civile Internazionale -ICAO- dell'aeroporto da cercare", required = true) @PathVariable String icao){
	...
	public ResponseEntity<Aeroporto> getAeroportoIata(@ApiParam(value = "Codice Internazionale delle compagnie aeree", required = true) @PathVariable String iata){
	...
	public ResponseEntity<List<Aeroporto>> getAeroportoCitta(@ApiParam(value = "Ricerca per città", required = true) @PathVariable String citta){
